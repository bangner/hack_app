class SchoolInvitationMailer < ActionMailer::Base
  ...
  def invite_school_admin(invitation)
    body = ""
    body += "<p>Hi #{invitation.school.name},</p>"
    ...
    body += "<p><a href=\"" + new_school_admin_url(:school_id => invitation.school.id, :code => invitation.code).to_s + "\">Claim invitation here.</a></p>"
